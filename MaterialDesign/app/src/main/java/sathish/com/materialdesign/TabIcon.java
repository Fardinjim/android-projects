...
public class TabIcon extends ActionBarActivity implements MaterialTabListener{
    ...
    class MyPagerAdapter extends FragmentPagerAdapter  //for tabs
    {
        ...
        int icons[] = {R.drawable.shop_music, R.drawable.shop_art
                , R.drawable.shop_dance};
        ...
        @Override   //ITS OF NO USE IN ICON TABS
