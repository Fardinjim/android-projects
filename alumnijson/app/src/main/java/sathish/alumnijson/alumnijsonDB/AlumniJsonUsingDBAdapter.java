 ...
 */
public class AlumniJsonUsingDBAdapter extends UltimateViewAdapter {

    Activity activity;
    BrowseAlumniJsonUsingDBDTO eachAlumniDetail;
    private List<BrowseAlumniJsonUsingDBDTO> oneRowAlumniDetail;


    // initialize the adapter
    public AlumniJsonUsingDBAdapter(Activity activity, List<BrowseAlumniJsonUsingDBDTO> oneRowAlumniDetail) {
